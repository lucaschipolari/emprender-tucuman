  ...
  useEffect(() => {
    ...
    if (publicacionSeleccionada && categorias.length > 0) {
      reset({
        ...
        categoriaId: publicacionSeleccionada.categoriaId.toString(), // asegúrate que sea string
      });
                  ...
                  <input
                    ...
                    {...register("precioOferta", {
                      ...
                      validate: (value) => {
                        ...
                        if (isNaN(oferta)) return "Debe ser un número válido";
                        if (oferta >= precio)
